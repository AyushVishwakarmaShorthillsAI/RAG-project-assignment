...
test_cases=[
  ...
  },
  {
    ...
    "Answer": "Around 100 to 115 billion tons.",
    "Context": "Photosynthetic organisms also convert around 100 to 115 billion tons... of carbon into biomass per year."
  },
  {
...
,
  {
    ...
    "Answer": r"The product of their standard deviations cannot be smaller than half the reduced Planck constant ($\hbar/2$).",
    "Context": r"The uncertainty principle states that $sigma _{X}\sigma _{P}\geq {\frac {\hbar }{2}}$...Either standard deviation can in principle be made arbitrarily small, but not both simultaneously."
  },
  {
  ...
  },
  {
    ...
    "Answer": "Entangled.",
    "Context": r"Not all states in the joint Hilbert space $\mathcal {H}}_{AB}$ can be written in this form, however...States that are not separable are called entangled."
  },
  {
    ...
    "Context": r"Here $H$ denotes the Hamiltonian, the observable corresponding to the total energy of the system, and $\hbar$ is the reduced Planck constant...The Hamiltonian $H$ is known as the generator of time evolution..."
  },
  {
    ...
    "Context": r"The infinite potential walls of the box determine the values of $C,D,$ and $k$ at $x=0$ and $x=L$ where $\psi$ must be zero. Thus, at $x=0$, $\psi(0)=0=C\sin(0)+D\cos(0)=D$ and $D=0$. At $x=L$, $\psi(L)=0=C\sin(kL)$..."
  }
,
  {
    ...
    },
{
    ...
    },
    {
      ...
      "Answer": r"The ISCO is the closest stable circular orbit around a black hole. Any slight inward disturbance will cause an object in this orbit to spiral into the black hole. For a Schwarzschild black hole, the radius of the ISCO ($r_{\rm {ISCO}}$) is $3r_s$, which is equal to $\frac{6\,GM}{c^{2}}$.",
      "Context": r"In general relativity, however, there exists an innermost stable circular orbit (often called the ISCO), for which any infinitesimal inward perturbations to a circular orbit will lead to spiraling into the black hole...The location of the ISCO depends on the spin of the black hole, in the case of a Schwarzschild black hole (spin zero) is:$r_{\rm {ISCO}}=3\,r_{s}={\frac {6\,GM}{c^{2}}}$"
    },
    {
    ...
    },
{
    ...
    },
 {
    ...
    },
    {
      ...
      "Context": r"In this setting, theterminal sideof an angleAplaced instandard positionwill intersect the unit circle in a point (x,y), wherex=cos⁡A{\displaystyle x=\cos A}andy=sin⁡A{\displaystyle y=\sin A}."
    },
    {
    ...
    },
    {
      ...
      "Context": r"When extended as functions of real or complex variables, the followingformulaholds for the complex exponential: $e^{ix}=\cos x+i\sin x$."
    },
    {
    ...
    },
    {
      ...
      "Context": r"a measureP{\displaystyle P\,}defined onF{\displaystyle {\mathcal {F}}\,}is called aprobability measureifP(Ω)=1.{\displaystyle P(\Omega )=1.\,}"
    },
    {
...
,
{
    ...
    },
    {
      ...
      "Context": r"Thepower setof a setA, denotedP(A){\displaystyle {\mathcal {P}}(A)}, is the set whose members are all of the possiblesubsetsofA."
    },
    {
...
},
{
    ...
    "Context": r"In the mathematically rigorous formulation of quantum mechanics, the state of a quantum mechanical system is a vectorψ{\displaystyle \psi }belonging to a (separable) complexHilbert spaceH{\displaystyle {\mathcal {H}}}."
},{
    ...
    "Context": r"This vector is postulated to be normalized under the Hilbert space inner product, that is, it obeys⟨ψ,ψ⟩=1{\displaystyle \langle \psi ,\psi \rangle =1}..."
},{
    ...
    "Context": r"...and it is well-defined up to a complex number of modulus 1 (the global phase), that is,ψ{\displaystyle \psi }andeiαψ{\displaystyle e^{i\alpha }\psi }represent the same physical system."
},{
    ...
    "Context": r"After the measurement, if resultλ{\displaystyle \lambda }was obtained, the quantum state is postulated tocollapsetoλ→{\displaystyle {\vec {\lambda }}}..."
},{
    ...
    "Context": r"The operatorU(t)=e−iHt/ℏ{\displaystyle U(t)=e^{-iHt/\hbar }}is known as the time-evolution operator..."
},{
...
},
{
    ...
    "Context": r"Bothbeam splittersare modelled as the unitary matrixB=12(1ii1){\displaystyle B={\frac {1}{\sqrt {2}}}{\begin{pmatrix}1&i\\i&1\end{pmatrix}}}..."
},{
    "Question": "What unitary matrix represents the phase shifter on the upper arm of the interferometer?",
    "Answer": "P = [[1, 0], [0, e^(iΔΦ)]]",
    "Context": r"The phase shifter on the upper arm is modelled as the unitary matrixP=(100eiΔΦ){\displaystyle P={\begin{pmatrix}1&0\\0&e^{i\Delta \Phi }\end{pmatrix}}}..."
},{
    "Question": "If a photon enters the interferometer from the left, what is the probability of it being detected at the top?",
    "Answer": "p(u) = cos²(ΔΦ/2)",
    "Context": r"...and the probabilities that it will be detected at the right or at the top are given respectively byp(u)=|⟨ψu,BPBψl⟩|2=cos2⁡ΔΦ2{\displaystyle p(u)=|\langle \psi _{u},BPB\psi _{l}\rangle |^{2}=\cos ^{2}{\frac {\Delta \Phi }{2}}}..."
},{
    ...
    "Answer": "p(u) = p(l) = 1/2.",
    "Context": r"...and the probabilities are given byp(u)=p(l)=1/2{\displaystyle p(u)=p(l)=1/2}, independently of the phaseΔΦ{\displaystyle \Delta \Phi }."
},{
